...
(pv -f -w 90 -N "Extracting dataset annotations" /home/hk-project-p0024638/uruox/data/iTRAP-FLOWER/calvin_policy_dataset/both_cams/vis_lang_clip_resnet50.tar | tar -C $TMPDIR/data -xf -) 2>&1

# Activate the virtualenv / conda environment
source /home/hk-project-p0024638/uruox/miniconda3/bin/activate itrap-new
